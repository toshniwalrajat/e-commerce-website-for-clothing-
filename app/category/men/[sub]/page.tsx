...
export default async function MenSubPage({ params }: { params: { sub: string } }) {
  const list = fetchByPath(['men', params.sub]);
  return (
    <div className="mx-auto max-w-7xl px-4 py-8">
      <h1 className="mb-4 font-medium capitalize">Men / {params.sub}</h1>
